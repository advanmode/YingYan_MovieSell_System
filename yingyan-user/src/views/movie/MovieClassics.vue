<template>
    <div>
        ...
        <div class="pageHelper">
            <el-pagination @current-change="handleCurrentChange" :current-page="pageNum" :page-size="pageSize" background layout="prev, pager, next" :total="total">
            </el-pagination>
        </div>
    </div>
</template>
...
export default {
    ...
    computed: {
        listenChange() {
            const { movieCategoryId, movieAreaId, movieAgeId, orderByColumn } =
                this;
