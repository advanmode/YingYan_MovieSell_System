                        ...
                        <div class="movie-index">
                            ...
                            <div style="display: flex">
                                ...
                                <div class="score-container">
                                    <el-rate :value="movieInfo.movieScore/2" allow-half disabled text-color="#ff9900">
                                    </el-rate>
            ...
            <div class="movie-info-detail clearfix">
                <div class="main-content">
                    <div class="crumbs-nav-container">
                        <a href="/welcome">鹰眼电影</a> &gt; <a href="/movie">电影</a> &gt; {{movieInfo.movieNameCn}}
                    </div>
                        ...
                        <el-tab-pane label="介绍" name="introduction">
                            <div class="tab-body">
                                ...
                                <div class="module">
                                    ...
                                    <div class="mod-content">
                                        <div class="actors-container">
                                            <div class="actors-group" v-for="(item,index) in movieInfo.actorRoleList" :key="index">
                                                <div class="actors-type">
                                                    {{item.actorRoleName}}
                                                </div>
                                                <div class="actors-list clearfix">
                                                    <div class="actor" v-for="(actor,index) in item.actorList" :key="index">
                                ...
                                <div class="module">
                                    ...
                                    <div class="mod-content">
                                        <div class="pictures-list">
                                            ...
                                            <el-image class="default-img" :src="movieInfo.moviePictures[0]" :preview-src-list="movieInfo.moviePictures" v-if="movieInfo.moviePictures.length > 0">
                                            </el-image>
                                            <div class="little-pictures">
                                                <el-image class="default-img" v-for="(item,index) in movieInfo.moviePictures.slice(1)" :key="index" :src="item" :preview-src-list="movieInfo.moviePictures">
                                                </el-image>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="module">
                                    ...
                                    <div class="mod-content">
                                        <div class="comment-container" v-for="(item,index) in movieInfo.movieCommentList" :key="index">
                                            <div>
                                                <!-- 头像 -->
                                                <el-avatar :src="item.sysUser.userPicture" class="user-avatar">
                                                </el-avatar>
                                            </div>
                                            <!-- 用户名、评分、评论内容 -->
                            ...
                            <div class="tab-body">
                                <div class="pictures-list">
                                    <div class="little-pictures">
                                        ...
                                        <el-image fit="cover" class="default-img" v-for="(item,index) in movieInfo.moviePictures" :key="index" :src="item" :preview-src-list="movieInfo.moviePictures">
                                        </el-image>
                                    </div>
                                </div>
                            </div>
    ...
    methods: {
        async getMovieInfo() {
            ...
            this.movieInfo.movieCategoryList = this.movieInfo.movieCategoryList
                ...
                .join(" ");
            this.movieInfo.movieCommentList =
                this.movieInfo.movieCommentList.slice(
                    0,
                    Math.min(10, this.movieInfo.movieCommentList.length)
                );
            this.movieInfo.movieCommentList =
                this.movieInfo.movieCommentList.map((obj, index) => {
                    obj.sysUser.userPicture =
                        this.httpURL + JSON.parse(obj.sysUser.userPicture)[0];
                    return obj;
                });
        },
        showActors() {
        ...
        async submitComment() {
            ...
            this.commentForm.commentTime = moment().format(
                "YYYY-MM-DD HH:mm:ss"
            );
