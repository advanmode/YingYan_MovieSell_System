<template>
    <div class="user-info-container">
        <div style="width: 30%">
            <h1>用户头像</h1>
            <el-upload action="" list-type="picture-card" :auto-upload="false" :limit="1" :file-list="pics" :on-change="handleChange" :on-success="handleSuccess" :on-error="handleError" :on-exceed="handleExceed" ref="pictureRef" :http-request="submitFile">
                <i slot="default" class="el-icon-plus"></i>
                <div slot="file" slot-scope="{file}">
                    <img class="el-upload-list__item-thumbnail setH" :src="(picDialog?'':global.base)+file.url" alt="">
        ...
        <div style="width: 70%">
            <el-form :model="loginUser" ref="editFormRef" label-width="80px">
                ...
                <el-form-item label="生日" prop="birthday">
                    <el-date-picker v-model="information.birthday" type="date" placeholder="选择日期">
                    </el-date-picker>
                </el-form-item>
                <el-form-item label="生活状态" prop="condition">
                    <el-radio v-model="information.condition" label="1">单身</el-radio>
                    <el-radio v-model="information.condition" label="2">恋爱</el-radio>
                    <el-radio v-model="information.condition" label="3">已婚</el-radio>
                    <el-radio v-model="information.condition" label="4">有小孩</el-radio>
                </el-form-item>
                <el-form-item label="从事行业" prop="job">
                    <el-cascader v-model="information.job" :options="options">
                    </el-cascader>
                </el-form-item>
                <el-form-item label="兴趣" prop="hobbies">
                    <el-checkbox-group v-model="information.hobbies">
...
export default {
    ...
    methods: {
        ...
        async editUser() {
            ...
            await axios
                .put("sysUser", JSON.stringify(this.loginUser))
                .then((resp) => {
