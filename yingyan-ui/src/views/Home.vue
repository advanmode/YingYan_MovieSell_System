    ...
    <el-container class="home-container">
        <el-header>
            <div class="span-container" style="padding: 5px" @click="toWelcome">
                <img src="../assets/img.png" alt="" height="40px" width="40px">
                <span>鹰眼电影后台管理系统</span>
            </div>
        ...
        <el-container>
            <el-aside :width="isCollapsed ? '64px' : '250px'">
                ...
                <!--侧边栏菜单-->
                <el-menu background-color="#333744" text-color="#fff" active-text-color="#409EFF" unique-opened :collapse="isCollapsed" :collapse-transition="false" :router="true" :default-active="$route.path">
                    <!--一级菜单-->
