        ...
        <el-table-column label="操作" width="180">
          <template slot-scope="scope">
            <el-tooltip effect="dark" content="修改影厅信息" placement="top" :enterable="false" :open-delay="500">
              <el-button v-if="isCinemaOwner(scope.row.cinemaId)" type="primary" icon="el-icon-edit" size="mini"
                         @click="showEditDialog(scope.row.cinemaId, scope.row.hallId)"></el-button>
            </el-tooltip>
            <el-tooltip effect="dark" content="删除影厅" placement="top" :enterable="false" :open-delay="500">
              <el-button type="danger" icon="el-icon-delete" size="mini"
                         @click="deleteHallById(scope.row.cinemaId, scope.row.hallId)"></el-button>
            </el-tooltip>
            <el-tooltip effect="dark" content="安排座位" placement="top" :enterable="false" :open-delay="500">
              <el-button v-if="isCinemaOwner(scope.row.cinemaId)" type="warning" icon="el-icon-setting" size="mini"
                         @click="arrangeSeat(scope.row.cinemaId, scope.row.hallId)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="安排座位" :visible.sync="arrangeDialogVisible" :width="arrangeDialogWidth">
      ...
      <div class="row" v-for="(value, key) in seats">
        ...
        <div style="display: flex; justify-content: flex-end">
          <span class="seat" :class="isSelected[seats[key][index]]" @click="pressSeat(key, index)"
